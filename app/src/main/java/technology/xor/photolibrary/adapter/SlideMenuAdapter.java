package technology.xor.photolibrary.adapter;
...
public class SlideMenuAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		// mViewHolder.imgLogo.setColorFilter(ContextCompat.getColor(context, R.color.accent));

		SlideData mSlideData = SlideDataS.get(position);
		mViewHolder.txtName.setText(mSlideData.getName());
		mViewHolder.txtName.setTextColor((mSlideData.getState() == 0) ? Color.parseColor("#CFD8DC"):Color.parseColor("#455A64"));
