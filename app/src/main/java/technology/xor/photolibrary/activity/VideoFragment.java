...
import technology.xor.photolibrary.component.PhoneMediaVideoController;
import technology.xor.photolibrary.component.VideoThumbleLoader;

public class VideoFragment extends Fragment implements PhoneMediaVideoController.loadAllVideoMediaInterface {

	public static final String PACKAGE = "technology.xor.photogalary";
