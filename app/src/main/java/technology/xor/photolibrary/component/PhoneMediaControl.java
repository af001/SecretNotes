package technology.xor.photolibrary.component;
	...
	public static void loadGalleryPhotosAlbums(Context mContext , final int guid) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                System.out.println("Folder: " + cameraFolder);
                Integer cameraAlbumId = null;

                Cursor cursor = null;
                // ApplicationOwnGallery.applicationContext.getContentResolver().takePersistableUriPermission(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, Intent.FLAG_GRANT_READ_URI_PERMISSION);
                try {
